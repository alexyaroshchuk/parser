...
class Commander
{
    ...
    {
        $message = "Использование: ./Commander.php --command url" . PHP_EOL
            . "--command url обязательные. " . PHP_EOL
            ...
            . "принимает обязательный параметр url (как с протоколом, так и без)." . PHP_EOL
